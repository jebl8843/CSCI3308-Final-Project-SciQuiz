...
var getQuestion = function (category, difficulty) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                // @ts-ignore
                difficulty !== null && difficulty !== void 0 ? difficulty : (difficulty = Object.keys(open_trivia_db_1.QuestionDifficulties)[Math.round(Math.random() * 2)]);
                categoryId = open_trivia_db_1.CategoryNamesPretty[category];
                if (!categoryId)
            ...
            case 1: return [2 /*return*/, (_a.sent()).map(function (result) { return ({
